...
**Open-core [Grok Build](https://github.com/xai-org/grok-build) skill — v0.3.4.**

Paste a table or report. Get **which chart**, **why not the usual pie**, and **how to make it**.

The differentiator is not another chart-chooser flowchart. It is **Nazh-grounded Taiwan zh-TW pedagogy** plus **43 named patterns** from real teach-viz lessons: 中文圖種名, 適不適合, 口述怎麼做.

[Install](#install-grok-build) · [30-second demo](#try-this-first) · [43 patterns](#43-named-patterns) · [Teams](COMMERCIAL.md) · [中文說明](#資料在說什麼)
...
Highlights: icicle / sunburst / treemap / voronoi tree · waterfall · funnel · dumbbell / slope / bump · **lollipop／棒棒糖** · **streamgraph／河流圖** · sankey / alluvial / chord · **boxplot／箱形圖** · raincloud / ridgeline / beeswarm / violin · hexbin / contour · **dot density** · **population pyramid／人口金字塔** · UpSet · bullet KPI · calendar heatmap · cartogram.
...
| `examples/` | 43 patterns (when / recommend / avoid / checklist) |
...
**開源核心的 Grok Build skill（v0.3.4）。** 丟進一張表或一份報表，它回答兩件事：**該畫哪種圖**、**怎麼做得出來**。

和一般「圖表選擇器」的差別：對齊納茲教圖的台灣繁體中文教學——先給中文圖種名（英文名）、適不適合、口述怎麼做，再給工具。內建 **43 個具名 pattern**，不是示意三張長條圖。
